...
public class FilingIndexMenu extends AbstractContainerMenu {
    ...
    public FilingIndexMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        ...
        this.addSlot(new SlotItemHandler(this.blockEntity.inventory,0, 80, 17));
    }
    ...
    public ItemStack quickMoveStack(Player playerIn, int pIndex) {
        ...
        if (pIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            if (sourceStack.getItem() instanceof IndexRangeUpgradeIronItem || sourceStack.getItem() instanceof IndexRangeUpgradeDiamondItem || sourceStack.getItem() instanceof IndexRangeUpgradeNetheriteItem) {
