...
public class FilingIndexMenu extends AbstractContainerMenu {
    ...
    public ItemStack quickMoveStack(Player playerIn, int pIndex) {
        ...
        if (pIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            if (sourceStack.getItem() instanceof IndexRangerUpgradeGold || sourceStack.getItem() instanceof IndexRangerUpgradeDiamond || sourceStack.getItem() instanceof IndexRangerUpgradeNetherite) {
