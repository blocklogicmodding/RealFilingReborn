...
public class FilingFolderScreen extends AbstractContainerScreen<FilingFolderMenu> {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (isMouseOverButton(mouseX, mouseY,
            ...
            PacketDistributor.sendToServer(new ExtractionPacket(ExtractionPacket.ExtractionType.FOLDER));
            return true;
        }
    ...
    protected void renderTooltip(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (isMouseOverButton(mouseX, mouseY,
                x + EXTRACT_BUTTON_X, y + EXTRACT_BUTTON_Y,
                EXTRACT_BUTTON_SIZE, EXTRACT_BUTTON_SIZE)) {
            Component tooltip = Component.translatable("gui.realfilingreborn.extract_items");
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        Component instruction = menu.isNBTFolder() ?
                Component.translatable("gui.realfilingreborn.nbt_folder.instruction") :
                Component.translatable("gui.realfilingreborn.folder.instruction");
        ...
        guiGraphics.drawString(this.font, instruction, scaledX, scaledY, 0xa19217, false);
