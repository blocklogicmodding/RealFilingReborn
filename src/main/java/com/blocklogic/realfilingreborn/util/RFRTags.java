...
public class RFRTags {
    public static class Blocks {
        ...
        public static final TagKey<Block> INDEX_CABLES = createTag("index_cables");
        public static final TagKey<Block> FILING_CONTROLLERS = createTag("filing_controllers");
    ...
    public static class Items {
        ...
        public static final TagKey<Item> CABINETS = createTag("cabinets");
