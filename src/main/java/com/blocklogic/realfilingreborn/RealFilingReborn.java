...
import com.blocklogic.realfilingreborn.screen.custom.*;
...
public class RealFilingReborn
{
    ...
    public static class ClientModEvents
    {
        ...
        public static void registerScreens(RegisterMenuScreensEvent event) {
            ...
            event.register(ModMenuTypes.FILING_FOLDER_MENU.get(), FilingFolderScreen::new);
            event.register(ModMenuTypes.FLUID_CANISTER_MENU.get(), FluidCanisterScreen::new);
        }
